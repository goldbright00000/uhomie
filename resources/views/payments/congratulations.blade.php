            ...
            <div class="column flow-form columns">
                <div class="column is-6">
                    <form method="POST" action="{{-- route($form_route) --}}" enctype="multipart/form-data" >
                        ...
                        <h5 style="font-size: 90%; !important"><strong>Estás cada vez mas cerca de vivir en tu nuevo hogar</strong></h5>
                            ...
                            <table id="tabla2">
                                ...
                                <tr>
                                    ...
                                    <td  style="padding: 10px 0px;">
                                        ...
                                        <span style="font-size: 0.75rem;">Ahora iniciaremos el proceso de firma digital de tu contrato con validez notarial</span>

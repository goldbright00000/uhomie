...
@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 2:</span> Dirección de tu Proyecto', 'close' => route('profile.agent')])
@section('content')
<div class="container" id="agent-second-step-two">
              ...
              <div class="div">
                  <form method="POST" action="" enctype="multipart/form-data" id="registration-form">
                    ...
                    @include('components.users.common-forms.location-data.form2', [
                        'cities' => $cities,
                        'entity' => $property,
                        'form_route' => 'users.agents.second-step.two',
                        'back_url' => route('users.agents.third-step.one').'/'. $property->id,
                        'company' => false
                    ])
              </div>
            </div>

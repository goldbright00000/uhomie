@extends('layouts.flujo-base',['navTitle' => '<span class="bold">Paso 7:</span> Arrendatario', 'close' => route('profile.owner')])
@section('custom-css')
	        ...
	        <div class="columns">
	            <div class="column is-7 flow-form">
	                ...
	                <div class="form-footer">
	                    <a href="@route('users.agents.third-step.six',['id' => $property->id])" class="button is-outlined">Atrás</a>

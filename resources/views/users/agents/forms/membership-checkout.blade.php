        ...
        <div class="columns">
            ...
            <div class="column side-payment is-5 is-offset-1">
                <form class="" action="@route('payments.memberships')" method="post">
                    ...
                    <h3 class="total-price">$ <span id="span_monto" style="font-size: 1.15rem;font-weight: 500;">{{ $membership->getFeatures()->package_amount }}</span> UF<span>+ IVA</span></h3>
                    <div class="control">
                        <label class="radio" >
    ...
    onAuthorize: function(data, actions) {
      return actions.payment.execute().then(function() {
        ...
        .done(function(response){
            window.location.replace("{{ route("users.agents.second-step") }}");
        })
      });
    }
  }, '#paypal-button');

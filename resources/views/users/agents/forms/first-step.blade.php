    ...
    <section class="section main-section">
        <div class="columns">
            <div class="column is-7">
                ...
                <span>tu formulario para vender las</span>
                <span>las propiedades que desees.</span>
                <a href="{{ route('users.agents.first-step.one') }}" class="button is-outlined is-primary btn-continue">Continuar</a>
            </div>
            <div class="column side-info small">
                ...
                <div class="info small">
                    <img src="{{ asset('images/foco.png') }}">
                    <p>Podrás publicar todas las propiedades que desees Vender. Vive la experiencia UHOMIE</p>
                    <div class="border"></div>
                </div>
            </div>
        </div>

@extends('layouts.flujo-base',['navTitle' => '<span class="bold">Paso 2.7:</span> Arrendatario', 'close' => route('profile.owner')])
@section('custom-css')
	        ...
	        <div class="columns">
	            <div class="column is-7 flow-form">
	                ...
	                <div class="form-footer">
	                    <a href="{{route('users.agents.second-step.six')}}" class="button is-outlined">Atrás</a>

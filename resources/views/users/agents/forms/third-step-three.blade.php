  @extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 3:</span> Fotografias', 'close' => route('profile.agent')])
  @section('styles')
  ...
  <div class="container" id="agent-third-step-three">
        ...
        <div class="columns">
            <div class="column is-7 flow-form">
                ...
                <div class="form-footer">
                    <a href="{{route('users.agents.third-step.two',['id' => $property->id])}}" class="button is-outlined">Atrás</a>
...
@endsection
@section('scripts')
    <!--<script src="{{ asset('js/agent-forms/second-step-three.js') }}" charset="utf-8"></script>-->
    <!--<script src="{{ asset('js/property-forms/first-step-three.js') }}" charset="utf-8"></script>-->
    <script src="{{ asset('js/property-forms/photos-project.js') }}" charset="utf-8"></script>
@endsection

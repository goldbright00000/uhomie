@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 5:</span> Servicios', 'close' => route('profile.agent')])

@section('content')
<div class="container" id="agent-third-step-five">
                            ...
                            <div class="column">
                                ...
                                <div class="field">
                                    <div class="label-field">
                                        ...
                                        <span>Filtar Servicios Básicos</span>
                                    </div>
                                    <div class="control">
                                ...
                                @foreach ($basic_services as $service)
                                    <label class="checkbox square">
                                        <input type="checkbox" name="amenities[]" class="check_amenities check_basic_amenity" value="{{ $service->id }}" {{ $property->amenities->contains($service->id) ? 'checked' : '' }} amenity="{{ $service->name }}">
                        ...
                        <div class="columns">
                            <div class="column">
                                ...
                                <div class="field">
                                    <div class="label-field">
                                        <img src="{{ asset('images/icono_lupa.png') }}">
                                        <span>Filtar Detalles de la Propiedad</span>
                                    </div>
                                    <div class="control">
                                ...
                                @foreach ($details_amenities as $service)
                                    <label class="checkbox square">
                                        <input type="checkbox" name="amenities[]" class="check_amenities check_details_amenity" value="{{ $service->id }}" {{ $property->amenities->contains($service->id) ? 'checked' : '' }} amenity="{{ $service->name }}">
                                        {{ $service->name }} <span class="fa fa-{{ $property->amenities->contains($service->id) ? 'minus' : 'plus' }}"></span>
                                    </label>
                                @endforeach
                            </div>
                        ...
                        <div class="columns">
                            <div class="column">
                                ...
                                <div class="field">
                                    <div class="label-field">
                                        <img src="{{ asset('images/icono_lupa.png') }}">
                                        <span>Filtar Reglas de la Propiedad</span>
                                    </div>
                                    <div class="control">
                                ...
                                @foreach ($rules_amenities as $service)
                                    <label class="checkbox square">
                                        <input type="checkbox" name="amenities[]" class="check_amenities check_rules_amenity" value="{{ $service->id }}" {{ $property->amenities->contains($service->id) ? 'checked' : '' }} amenity="{{ $service->name }}">
                                        {{ $service->name }} <span class="fa fa-{{ $property->amenities->contains($service->id) ? 'minus' : 'plus' }}"></span>
                                    </label>
                                @endforeach
                            </div>

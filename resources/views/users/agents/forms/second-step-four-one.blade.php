	        ...
	        <div class="columns">
	            <div class="column is-7 flow-form">
	                    ...
	                    <form method="POST" action="" enctype="multipart/form-data" id="registration-form">
							...
							<div id="profiles" renta="{{$property->rent}}" oferta_semanal="{{$property->week_sale}}" oferta_mensual="{{$property->month_sale}}" hora_llegada="{{$property->checkin_hour}}" noches_minimas="{{$property->minimum_nights}}" tarifa_limpieza="{{$property->cleaning_rate}}">
								...
								<div class="field">
									...
									<div class="control has-icons-left has-icons-right">
										<input v-model="limpieza" @keypress="onlyNumber" class="input monto_formato_decimales" type="text" autocomplete="off" name="cleaning_rate" id="tarifa_limpieza" value="{{ $property && !is_null($property->cleaning_rate) ? $property->cleaning_rate : '' }}" min="0">
										<span class="icon is-small is-left">
											$
										</span>
										<span class="icon is-small is-right">
	                ...
	                <div class="form-footer">
	                    <a href="{{route('users.agents.second-step.four')}}" class="button is-outlined">Atrás</a>

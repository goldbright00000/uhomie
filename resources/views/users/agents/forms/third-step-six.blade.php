@extends('layouts.flujo-base',['navTitle' => '<span class="bold">Paso 6:</span> Preferencias de visita', 'close' => route('profile.agent')])
@section('content')
	        ...
	        <div class="columns">
	            <div class="column is-7 flow-form" id="schedule">
	                ...
	                <div class="form-footer">
	                    <a href="@route('users.agents.third-step.five', ['id' => $property->id])" class="button is-outlined">Atrás</a>

...
@section('content')
<div class="container" id="agent-first-step-one">
    <section class="section main-section">
        <div class="columns">
            <div class="column is-7 flow-form">
              <div class="div">
                <form method="POST" action="{{ route('users.agents.first-step.one') }}" enctype="multipart/form-data" id="registration-form">
                  @include('components.users.common-forms.basic-data.form2', [
                  'countries' => $countries,
                  'civil_status' => $civil_status,
                  'user' => $user,
                  'back_url' => route('users.agents.first-step')
                  ])
            </div>

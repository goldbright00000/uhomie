  @extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 2.3:</span> Fotografias'])
  @section('styles')
  ...
  <div class="container" id="agent-second-step-three">
        ...
        <div class="columns">
            <div class="column is-7 flow-form">
                ...
                <div class="form-footer">
                    <a href="{{route('users.agents.second-step.two')}}" class="button is-outlined">Atrás</a>

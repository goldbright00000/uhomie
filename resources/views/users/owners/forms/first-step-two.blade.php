@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 1.2:</span> Tu direccion'])
@section('content')
<div class="container" id="own-first-step-two">
              ...
              <div class="div">
                  <form method="POST" action="" enctype="multipart/form-data" id="registration-form">
                    @include('components.users.common-forms.location-data.form2', [
                      'cities' => $cities,
                      'entity' => $user,
                      'back_url' => route('users.owners.first-step.one'),
                      'company' => false
                    ])
              </div>
            </div>

@extends('layouts.flujo-base',['navTitle' => '<span class="bold">Paso 4.1:</span> Arrendatario'])
@section('custom-css')
	            ...
	            <div class="column is-7 flow-form">
	                <div class="div">
						...
						<div class="form-resident" style="display: none;">
							<h1 class="form-title" style="font-weight: 600;">Tu propiedad es apta para <br> qué tipo de arrendatario:</h1>
	                ...
	                <div class="form-footer">
	                    <a href="{{route('users.owners.fourth-step')}}" class="button is-outlined">Atrás</a>

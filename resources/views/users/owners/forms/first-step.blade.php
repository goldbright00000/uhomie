    ...
    <section class="section main-section">
        <div class="columns is-tablet">
            <div class="column is-7">
                ...
                <span>tu formulario para publicar las</span>
                <span>propiedades que desees</span>
                <a href="{{ route('users.owners.first-step.one') }}" class="button is-outlined is-primary btn-continue">Continuar</a>
            </div>
            <div class="column side-info small">
                <div class="info small">
                    <img src="{{ asset('images/foco.png') }}">
                    <p>Podras siempre desde tu perfil</p>
                    <p>publicar nuevas propiedades sin costo</p>

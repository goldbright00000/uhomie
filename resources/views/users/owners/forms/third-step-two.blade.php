@extends('layouts.flujo-base',['navTitle' => '<span class="bold">Paso 3.2:</span> Preferencias de visita'])
@section('custom-css')
	<style media="screen">
	        ...
	        <div class="columns">
	            <div class="column is-7 flow-form" id="schedule">
	                ...
	                <div class="form-footer">
	                    <a href="{{route('users.owners.third-step.one')}}" class="button is-outlined">Atrás</a>

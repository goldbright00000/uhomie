@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 2.4:</span> Detalles de Propiedad'])
@section('content')
        ...
        <div class="columns">
            <div class="column is-7 flow-form">
                ...
                <div class="form-footer">
                    <a href="{{route('users.owners.second-step.three')}}" class="button is-outlined">Atrás</a>

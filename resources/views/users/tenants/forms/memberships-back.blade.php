@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 4:</span> Elige tu Membresía'])
        ...
        <div class="columns">
            ...
            <div class="column side-info">
                ...
                <div class="side-footer">
                    ...
                    <form method="get" action="@route('users.tenants.memberships-checkout')" id="form">

    ...
    <div class="container">
        <div>
          <img src="{{ asset('images/icons/logo_completo.png') }}">
        	<span class="nav-title is-hidden-mobile">Confirmar</span>
        </div>
	    ...
	    <div id="title-mobile" class="container is-hidden-tablet">
	    	<span class="nav-title">Confirmar</span>
	    </div>
        ...
        <div class="columns">
            <div class="column is-6">
                <div class="membership-info ">
                    ...
                    <a href="{{route('users.tenants.memberships.update')}}" class="button is-outlined is-primary">Cambiar</a>
                </div>
            ...
            <div class="column side-payment is-5 is-offset-1">
                <form class="" action="@route('payments.memberships')" method="post">
                    ...
                    @endif
                    <input type="hidden" name="back_url" value="{{url("/users/tenant/memberships-back")}}/">
                    ...
                    @endif
                    <input style="display: inline-block" type="submit" name="submit" value="@if($membership->name == 'Basic') FINALIZAR @else PAGAR @endif" class="button is-outlined is-primary">
                    </div>

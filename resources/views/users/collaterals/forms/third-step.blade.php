...
@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 1.2:</span> Tus dirección'])
@section('content')
<div class="container" id="collateral-third-step">
              ...
              <div class="div">
                  <form method="POST" action="" enctype="multipart/form-data" id="registration-form">
                    @include('components.users.common-forms.location-data.form2', [
                    	'cities' => $cities,
											'entity' => $user,
											'back_url' => route('users.collaterals.second-step'),
                      'company' => false
                    ])
              </div>
            </div>

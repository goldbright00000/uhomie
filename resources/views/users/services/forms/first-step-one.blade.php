@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 1.1:</span> Tus datos personales'])
@section('content')
<div class="container" id="personal-info-step">
    <section class="section main-section">
        <div class="columns">
            <div class="column is-7 flow-form">
              <div class="div">
                  <form method="POST" action="{{ route('users.services.first-step.one') }}" enctype="multipart/form-data" id="registration-form">
                  @include('components.users.common-forms.basic-data.form2', [
      							'countries' => $countries,
              			'civil_status' => $civil_status,
              			'user' => $user,
              			'back_url' => route('users.services.first-step')

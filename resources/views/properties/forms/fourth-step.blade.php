            ...
            <div class="column is-7 flow-form">
                <div>
                    ...
                    <div class="edit-step">
                        <div>
                            <span>Paso 3</span>
                            <span>Tu Arrendatario Ideal</span>
                        </div>
                        <div class="edit-right">
                            <img src="{{ asset('images/icono-ok.png') }}">
                            <a href="{{ route('properties.third-step', isset($property) ? $property->id : null) }}">Editar</a>
                        </div>
                    </div>
                ...
                <div class="form-footer">
                    <a href="{{ route('properties.third-step.one',['id' => $property->id]) }}" class="button">Atrás</a>
                    <a href="{{ route('properties.fourth-step.one',['id' => $property->id]) }}" class="button is-outlined is-primary">Continuar</a>
                </div>
            </div>

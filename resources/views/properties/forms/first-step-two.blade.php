@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 1.2:</span> Dirección de tu Propiedad', 'close' => route('profile.owner')])
@section('content')
<div class="container" id="own-second-step-two">
              ...
              <div class="div">
                  <form method="POST" action="" enctype="multipart/form-data" id="registration-form">
                    @include('components.users.common-forms.location-data.form2', [
                      'cities' => $cities,
                      'entity' => $property,
                      'back_url' => route('properties.first-step.one',['id' => $property->id]),
                      'company' => false
                    ])
              </div>
            </div>

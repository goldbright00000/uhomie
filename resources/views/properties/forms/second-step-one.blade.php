@extends('layouts.flujo-base',['navTitle' => '<span class="bold">Paso 2.1:</span> Condiciones', 'close' => route('profile.owner')])
@section('custom-css')
@endsection
@section('content')
	        ...
	        <div class="columns">
	            <div class="column is-7 flow-form">
									...
									<div class="form-office" style="display: none;">
										<div class="long_stay" style="display: none; margin-bottom: 2rem;">
											...
											<div class="field">
												...
												<div class="control has-icons-right">
													<input class="input monto_formato_decimales" type="text" step="any" autocomplete="off" name="penalty_fees" id="penalty_fees" value="{{ $property && !is_null($property->penalty_fees) ? $property->penalty_fees : '' }}" required>
													<span class="icon is-small is-right">
														UF
													</span>
												</div>
	                ...
	                <div class="form-footer">
	                    <a href="{{route('properties.second-step', ['id' => $property->id])}}" class="button is-outlined">Atrás</a>

...
@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 1.1:</span> Tu Propiedad', 'close' => route('profile.owner')])
@section('content')
...
<div class="container " id="own-second-step-one">
        ...
        <div class="columns">
            <div class="column is-7 flow-form">
                            ...
                            <div class="project" style="display:none">
                                ...
                                <div class="field">
                                    <div class="label-field">
                                        ...
                                        <span>Condicion del Propiedad</span>
                                    </div>
                                    <div class="control">
                                        <label class="radio">
                ...
                <div class="form-footer">
                    <a href="{{route('properties.first-step',['id' => $property->id])}}" class="button is-outlined">Atrás</a>

@extends('layouts.flujo-base', ['navTitle' => '<span class="bold">Paso 1.5:</span> Servicios', 'close' => route('profile.owner')])
        ...
        <div class="columns">
            <div class="column is-7 flow-form">
                ...
                <div class="form-footer">
                    <a href="{{route('properties.first-step.four',['id' => $property->id])}}" class="button is-outlined">Atrás</a>

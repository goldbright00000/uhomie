        ...
        <div class="column">
            <div class="field">
                ...
                <div class="control">
                    ...
                    <GmapAutocomplete id="_direccion_company" class="input" type="text"
...
Vue.use(VueGoogleMaps, {
  ...
  installComponents: true,
    ...
    export default {
        ...
        mounted() {
            document.getElementById("_direccion_company").value = this.info.address;
        },
        methods: {
            setPlace(place) {
                if (!place) return
                ...
                this.info.address = document.getElementById("_direccion_company").value;
            }
        }
    }

                ...
                <div class="columns is-multiline">
                    <div class="column is-12">
                        <div class="columns">
                           ...
                           <div class="column is-4">
                               <div class="control">
                                   <input class="input" type="text" :value="info.service">
                               </div>
                            </div>
                            <div class="column is-2">
                                <p :class="'contract-stt-'+info.service_stt">{{ stt_title[info.service_stt] }}</p>
                            </div>

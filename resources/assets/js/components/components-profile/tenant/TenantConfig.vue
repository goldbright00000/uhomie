<template>
    <div class="tenant-contracts">
        ...
        <panel-up-down title="Vincular cuentas de redes sociales" :save="false">
            <template slot-scope="data">
                <AttachingAccounts :info="info"  ></AttachingAccounts >
            </template>
        </panel-up-down>
...
<script>
    ...
    import AttachingAccounts from '../common/AttachingAccounts';

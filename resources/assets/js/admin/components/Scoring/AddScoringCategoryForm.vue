    ...
    <form novalidate class="md-layout" @submit.prevent="validateScoringCategory">
      <md-card class="md-layout-item md-size-80 md-small-size-100">
        <md-card-header :data-background-color="dataBackgroundColor">
          ...
          <p class="category">Ingrese los datos de la Categoria</p>
        </md-card-header>
        <md-card-content>
          <div class="md-layout">
      ...
      <md-snackbar :md-active.sync="scoringCategorySaved">Nueva Categoria registrada con exito!</md-snackbar>
    </form>
  </div>
</template>
...
<script>
  ...
  export default {
    name: "add-scoring-category-form",
    ...
    methods: {
      ...
      saveDataScoringCategory() {
        ...
        var url = '/adm/scoring/' + scoringId + '/categories/add'
        axios.post(url, {
          scoringId : scoringId,
          name : vm.form.name,

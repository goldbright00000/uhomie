    ...
    <form novalidate class="md-layout" @submit.prevent="validateScoringCategoryDetail">
      <md-card class="md-layout-item md-size-80 md-small-size-100">
        <md-card-header :data-background-color="dataBackgroundColor">
          <h4 class="title">Nuevo Detalle de Categoria</h4>
          <p class="category">Ingrese los datos del detalle</p>
        </md-card-header>
        <md-card-content>
          <div class="md-layout">
      ...
      <md-snackbar :md-active.sync="scoringCategoryDetailSaved">Nuevo detalle agregado con exito!</md-snackbar>
    </form>
  </div>
</template>
...
<script>
  ...
  export default {
    name: "add-scoring-category-detail-form",
    ...
    methods: {
      ...
      saveDataScoringCategory() {
        ...
        var url = '/adm/scoring/' + scoringId + '/categories/' + scoringCategoryId + '/details/add'
        axios.post(url, {

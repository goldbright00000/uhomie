            ...
            <div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
                <md-card>
                    <md-card-header data-background-color="black">
                        <h4 class="title">Crear Cupon</h4>
                        <p class="category">Formulario de creación de Cupon</p>
                    </md-card-header>
                    <md-card-content>
                        <form novalidate class="md-layout" @submit.prevent="validateCoupon">
                            <md-card class="md-layout-item md-size-50 md-small-size-100">
                                ...
                                <md-card-actions>
                                    <md-button type="submit" class="md-primary" :disabled="sending">Crear Cupon</md-button>
                                </md-card-actions>
                            </md-card>

                            <md-snackbar :md-active.sync="couponSaved">Cupon Guardado exitosamente</md-snackbar>
                        </form>
                    </md-card-content>
                </md-card>
            </div>
...
export default {
    ...
    data: () => ({
      ...
      couponSaved: false,
      sending: false,
      saveDataUrl: '/adm/coupons/create'
    }),
    validations: {
      form: {
            name: {

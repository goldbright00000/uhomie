        ...
        <md-card>
          ...
          <md-card-content>
            ...
            <div>
              ...
              <md-table v-model="categories" table-header-color="green" style="height: 60vh;overflow-x: hidden;" >
                <md-table-row slot="md-table-row" slot-scope="{ item }" >
                  ...
                  <md-table-cell md-label="Opciones">
                    ...
                    <md-button  class="md-just-icon md-simple md-primary">
                      <router-link :to="{path: '/scoring/' + $route.params.scoringId + '/categories/' + item.id + '/details'}"><md-icon>settings</md-icon></router-link>
                      <md-tooltip md-direction="top">Ver Detalles</md-tooltip>
                    </md-button>
                  </md-table-cell>
                </md-table-row>
              </md-table>
